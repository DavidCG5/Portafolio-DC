        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-white/60">
              Practicante Frontend – Ene 2024 a Jul 2024
            </p>
            <p className="text-white/80 mt-2">
              Desarrolle y mantuve funcionalidades para el proyecto Legal AI,
              optimizando procesos internos y mejorando la experiencia del
              usuario.
            </p>
          </div>
        </div>
