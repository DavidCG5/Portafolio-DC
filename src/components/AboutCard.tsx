        ...
        <div className="flex flex-col gap-4">
          <div>
            <h2 className="text-3xl font-bold text-white mb-2">
              ¡Hola! Soy <span className="text-blue-400">David</span>!
            </h2>
            <p className="text-white/80 leading-relaxed">
              Desarrollador de software apasionado por crear experiencias
              digitales modernas e intuitivas.
            </p>
            <p className="text-white/70 leading-relaxed mt-2">
              Participando en proyectos como{" "}
              <span className="text-blue-300">Legal AI</span>. Me encanta
              aprender tecnologías nuevas, mejorar interfaces y desarrollar
              componentes reutilizables.
            </p>
            <p className="text-white/60 leading-relaxed mt-2">
              En mis tiempos libres disfruto de los videojuegos, el gimnasio y
              la música. Busco siempre crecer como profesional y persona.
            </p>
          </div>
