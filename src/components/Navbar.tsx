    ...
    <>
      <nav className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 px-6 py-3 w-[90%] max-w-4xl rounded-full backdrop-blur-md bg-white/5 shadow-[0_0_30px_rgba(6,2,255,0.2)] flex justify-between items-center">
        ...
        <ul className="hidden sm:flex gap-6 text-md font-medium text-white/80">
          ...
          <li>
            <Link href="/portafolio" className="hover:text-blue-300 transition">
              Portafolio
            </Link>
          </li>
          <li>
            <Link href="/sobremi" className="hover:text-blue-300 transition">
              Sobre Mi
            </Link>
          </li>
        </ul>
      ...
      {menuOpen && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex flex-col items-center justify-center text-white animate-fadeIn">
          {/* Botón cerrar */}
          <button
